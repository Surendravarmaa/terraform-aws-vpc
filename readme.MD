...
* commom_tags (Required): User should provide their tags related to their project. Type is map.
...
* acceptor_vpc_id (Optional): Default value is empty, default VPC IFD would be taken. Type is string.
...
* databse_subnet_group_id: A database subnet group ID created.
